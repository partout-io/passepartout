...
import com.algoritmico.passepartout.ui.extensions.localizedStatusFromErrorCode
...
fun ProfileRow(
    ...
    val statusDescription = lastErrorCode?.localizedStatusFromErrorCode() ?: status.statusText()
